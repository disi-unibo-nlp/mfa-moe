...
with higher accuracy. Figure~\ref{fig:router-value-accuracy}
...
These definitions apply across models with different native selection counts.

Rank-prefix curves (top 2, 4, 6, then all selected versus
the rest) require additional probability summaries. Only the all-selected endpoint $G$ is saved. Separate entropy
...
require new feature extraction and replay.
