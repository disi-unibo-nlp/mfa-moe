...
Class-conditioned router features and the proportion of reasoning assigned
to each class describe different properties. The following plots use
...
to correctness and interventions conditioned on those paths is future work. The currently sampled labels do
