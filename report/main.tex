...
capability and is not evidence about Qwen router dynamics.
...
overprediction remains substantial.  The next priorities are a clean PRM800K
rerun, adjudication of episode-unit artifacts, paired seed-versus-GEPA outer
evaluation, stronger event supervision, and only then causal routing
intervention.
